...
bitex.ui.RemittancesBox.templates.RemittancesBoxCurrency = function(opt_data) {
  return '<tr><td style="padding: 4px;"><strong>' + soy.$$escapeHtml(opt_data.remittance_pair[1]) + '</strong></td><td style="padding: 4px;"><span id="' + soy.$$escapeHtml(opt_data.id) + '_' + soy.$$escapeHtml(opt_data.remittance_pair[0]) + '_buy"  data-blink-class="md-blink"></span><span> / <span><span id="' + soy.$$escapeHtml(opt_data.id) + '_' + soy.$$escapeHtml(opt_data.remittance_pair[0]) + '_sell" data-blink-class="md-blink"></span></td></tr>';
};
...
bitex.ui.RemittancesBox.templates.RemittancesBox = function(opt_data) {
  ...
  output += '<div id="' + soy.$$escapeHtml(opt_data.id) + '" class="remittance-box"><table class="table table-bordered table-condensed remittance-box-table"><thead><tr><td colspan="2"><strong>' + MSG_UNNAMED_37 + '</strong></td></tr></thead><tbody class="remittance-box-content">' + bitex.ui.RemittancesBox.templates.RemittancesBoxCurrencies(opt_data) + '</tbody></table></div>';
  return output;
};
